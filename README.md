...
6. Prompts for git identity and commit signing (1Password, this machine's
   SSH key, or none), written to the uncommitted `~/.gitconfig.local` —
   after the picker so a just-installed 1Password counts
